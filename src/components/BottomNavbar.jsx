...
import { RiSearchFill, RiUser4Fill , RiSearchLine, RiUser4Line    } from "react-icons/ri";
import { GoHome, GoHomeFill  } from "react-icons/go";
import { AiOutlineShopping, AiFillShopping, AiOutlineQuestionCircle, AiFillQuestionCircle } from 'react-icons/ai';

const navItems = [
  { outlineIcon: <GoHome size={24} />, filledIcon: <GoHomeFill  size={24} />, text: "Home", to: "/" },
  { outlineIcon: <RiSearchLine  size={24} />, filledIcon: <RiSearchFill size={24} />, text: "Search", to: "/search" },
  ...
  { outlineIcon: <RiUser4Line  size={24} />, filledIcon: <RiUser4Fill   size={24} />, text: "Profile", to: "/profile" },
];
